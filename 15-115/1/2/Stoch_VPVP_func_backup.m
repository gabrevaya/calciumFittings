...
if load_previous_data
    % load('stoch_search_20millions.mat')
    % load('./results/workspace_MaxIter14Lam532_2ndglobalStep_fromOptim.mat')
%     load('./results/Stoch_VPVP/Stoch_VPVP_Search_NoOptim_err_weight0.1.mat')
%     load('./stoch_search_400000_errWeight0.1.mat')
% load('./Stoch_VPVP_Search_NoOptim_err_weight0.1.mat')
...
%         if 0
        if or(mod(iter,optim_freq)==0, iter == optim_start),
            ...
            VPVP_params.MaxIter_X = 200;
            VPVP_params.MaxIter = 200;
            VPVP_params.optTol_X = 1e-5/downsample;%5
            VPVP_params.progTol_X = 1e-9/downsample;%9
            VPVP_params.optTol_aW = 1e-3/downsample;%4
            VPVP_params.progTol_aW = 1e-6/downsample;%8
